...
const SolutionCard: React.FC<{ icon: string; title: string; desc: string }> = ({ icon, title, desc }) => (
  <div className="bg-white p-8 rounded-2xl border border-slate-100 hover:border-indigo-200 hover:shadow-xl transition-all group h-full text-left">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-20">
        ...
        <p className="text-lg text-slate-600 max-w-3xl mx-auto">
          Internal resources detailing mathematical frameworks and solution methodologies.
        </p>
      </div>
      ...
      <section className="mb-24">
        <div className="flex items-center gap-4 mb-10">
          ...
          <h2 className="text-3xl font-bold text-slate-900">Computational Complexity</h2>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
